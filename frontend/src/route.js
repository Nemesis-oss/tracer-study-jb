...
import Kerja from "./pages/admin/Table/Kerja";
import KerjaDanKuliah from "./pages/admin/Table/KerjaDanKuliah";
import Kuliah from "./pages/admin/Table/Kuliah";
import MencariKerja from "./pages/admin/Table/MencariKerja";
import Usaha from "./pages/admin/Table/Usaha";
import EditDataIjazah from "./pages/admin/FormEdit/EditDataIjazah";
import EditDataUser from "./pages/admin/FormEdit/EditDataUser";
import EditDataKerja from "./pages/admin/FormEdit/EditDataKerja";
import EditDataKerjaDanKuliah from "./pages/admin/FormEdit/EditDataKerjaDanKuliah";
import EditDataKuliah from "./pages/admin/FormEdit/EditDataKuliah"
import EditDataMencariKerja from "./pages/admin/FormEdit/EditDataMencariKerja";
import EditDataUsaha from  "./pages/admin/FormEdit/EditDataUsaha"
export {
  HalamanAwal,
  Login,
  Registrasi,
