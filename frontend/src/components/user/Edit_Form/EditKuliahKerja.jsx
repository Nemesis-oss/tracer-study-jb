...
const EditKuliahKerjaLayout = () => {
    ...
    const readSingleKuliahKerja = async () => {
        try {
            ...
            const dataKuliahKerja = response.data.data
            setJabatan(dataKuliahKerja.jabatan)
            setJenjang(dataKuliahKerja.jenjang)
            setPerusahaan(dataKuliahKerja.nama_perusahaan)
...
export default EditKuliahKerjaLayout