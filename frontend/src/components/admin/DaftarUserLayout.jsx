...
const DaftarUserLayout = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.tanggal_lahir}</div>,
    },
    {
      name: "Nomor Ijazah",
      selector: (row) => row.nomor_ijazah,
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.nomor_ijazah}</div>,
    },
    {
      name: "Jurusan",
      selector: (row) => row.jurusan,
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.jurusan}</div>,
    },
    {
      name: "Angkatan",
    ...
    },
    {
      ...
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.email}</div>,
    },
    {
      name: "Nomor WA",
      selector: (row) => row.nomor_WA,
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.nomor_WA}</div>,
    },
    {
      name: "Username",
      selector: (row) => row.username,
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.username}</div>,
    },
    {
      name: "Aksi",
      cell: (row) => (
        <>
          {/* Edit */}
          <Link to={`/admin/daftar-user/edit-data-user/${row._id}`}>
            <button
