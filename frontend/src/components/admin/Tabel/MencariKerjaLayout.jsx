...
const MencariKerjaLayout = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.alamat}</div>,
    ...
    },
    {
      ...
      sortable: true,
      cell: (row) => <div style={{ whiteSpace: 'normal', height: 'auto' }}>{row.alasan}</div>,
    ...
    },
    {
      ...
      cell: (row) => (
        <>
          {/* edit */}
          <Link to={`/admin/mencari-kerja/edit-data-mencari-kerja/${row.user}`}>
            <button
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        await api.delete(`/mencari-kerja/${id}`)
  ...
  const readAllMencariKerja = async () => {
    try {
