...
const UsahaLayout = () => {
  const EditButton = () => (
    <Link to={"/admin/usaha/edit-data-usaha"}>
      <button
  ...
  const item = [
    {
      ...
      angkatan: "1988",
      usaha: "Kelontong",
      alamat_usaha: "Jl. Godean Raya no.168",
      tahun_usaha: "2023",
    },
    {
      id: 2,
      ...
      angkatan: "1984",
      usaha: "Nelayan",
      alamat_usaha: "Jl. Gunung Kidul no.999",
      tahun_usaha: "1111",
    },
    {
      id: 3,
      ...
      angkatan: "2000",
      usaha: "Toko Kosmetik",
      alamat_usaha: "Jl. Babarsari no.1",
      tahun_usaha: "0222",
    },
    {
      id: 4,
      ...
      angkatan: "2002",
      usaha: "Pencopet",
      alamat_usaha: "Jl. Tidak dikenal no.6969",
      tahun_usaha: "1945",
    },
    {
      id: 5,
  ...
  const handleFilter = (e) => {
    ...
    const newData = item.filter((row) => {
      return (
        ...
        row.usaha.toLowerCase().includes(value) ||
        row.alamat_usaha.toString().toLowerCase().includes(value) ||
  ...
  return (
    <div>
      ...
      <div className="md:absolute md:left-60 md:top-14 p-8 md:w-10/12 w-screen md:mt-0 mt-10 z-10">
        <h1 className="font-semibold">Tabel Usaha</h1>
